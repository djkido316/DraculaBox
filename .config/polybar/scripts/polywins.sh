...
#active_text_color="#282A37"
active_bg= "#787c99"
active_underline="#282A36"

inactive_text_color="#414868"
#inactive_bg="#282A37"
#inactive_underline="#EBECF0"

separator=" | "
show="window_class" # options: window_title, window_class, window_classname
forbidden_classes="Polybar stalonetray Yad XTer Conky Gmrun Gsimplecal Dunst"
empty_desktop_message="Desktop"
empty_desktop_foreground="#282A37"
